...
public class AddTeacher extends JFrame implements ActionListener {
    ...
    AddTeacher(){
        ...
        add(tfFatherName);
        //roll no
        JLabel lblEmId = new JLabel("Emp ID");
        lblEmId.setBounds(50,200,100,30);
        lblEmId.setFont(new Font("serif",Font.BOLD,30));
        add(lblEmId);
        //Roll text field
        lblRandomNo = new JLabel("2644"+firstFour);
        ...
        add(tfInter);
        //combo box education
        JLabel lblCBQualification = new JLabel("Education");
        lblCBQualification.setBounds(50,400,250,30);
        lblCBQualification.setFont(new Font("serif",Font.BOLD,30));
        add(lblCBQualification);
        //combo box courses
